...
pub fn usage() -> String {
    [
        ...
        "  agentflow agent run [--apply] [--flow <flow-id>] [--max-apply <n>] [--propose-synth] [--infer-params] [--synthesizer <cmd>] [--auto-forage] [--forage-max <n>] [--forage-script <path>] [--python <bin>] [--json] [--path <path>]",
