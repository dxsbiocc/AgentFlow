...
runs deterministically. For real, working network implementations see the
siblings `crossref_verify.py` (Crossref API: retraction + preprint publication +
Unpaywall OA) and `pubmed_verify.py` (NCBI E-utilities: retraction via the
`Retracted Publication` type + PMC open access).
"""
